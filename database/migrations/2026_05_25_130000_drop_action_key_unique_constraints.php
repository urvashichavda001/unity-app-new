...
return new class extends Migration
{
    ...
    {
        DB::statement('ALTER TABLE life_impact_histories DROP CONSTRAINT IF EXISTS life_impact_histories_action_key_unique');
        DB::statement('ALTER TABLE life_impact_histories DROP CONSTRAINT IF EXISTS unique_action_key');
        DB::statement('DROP INDEX IF EXISTS life_impact_histories_action_key_unique');
