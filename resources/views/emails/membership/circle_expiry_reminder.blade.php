...
@section('title', 'Your Circle Membership Is Expiring Soon')
...
@section('content')
    ...
    <p style="margin:0 0 16px 0; color:#e2e8f0; font-size:15px; line-height:22px;">
        Your Circle membership is expiring on {{ $expires_at }}.
    </p>
    <p style="margin:0 0 16px 0; color:#e2e8f0; font-size:15px; line-height:22px;">
        To continue enjoying all Circle features, resources, and networking benefits, please renew your Circle membership before the expiration date.
    </p>
...
@section('footer')
    <p style="margin:0; font-size:12px; line-height:18px; color:#d1d5db;">
        This email was sent to notify you about your Circle membership status. If you have already completed the renewal process, please ignore this message.
    </p>
@endsection
