...
@section('title', 'Contact Post Details')
...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
    <div>
        <p class="text-muted mb-1">Contact Posts</p>
        <h1 class="h4 mb-0">Contact Post Details</h1>
    </div>
    <a href="{{ route('admin.contact-posts.index') }}" class="btn btn-outline-secondary">Back to Contact Posts</a>
</div>
